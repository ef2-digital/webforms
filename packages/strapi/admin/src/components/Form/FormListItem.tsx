        ...
        <Flex justifyContent="right" alignItems="right">
          <Stack horizontal={true} spacing={3}>
            ...
            <Dialog
              ...
              title={formatMessage({ id: "webforms.dialog.confirm.title" })}
              isOpen={isVisible}
            >
                ...
                <Flex direction="column" alignItems="center" gap={2}>
                  <Flex justifyContent="center">
                    <Typography id="confirm-description">
                      {formatMessage({ id: "webforms.dialog.delete.text" })}
                    </Typography>
                  </Flex>
                </Flex>
              </DialogBody>
              <DialogFooter
                startAction={
                  <Button
                    ...
                    variant="tertiary"
                  >
                    {formatMessage({ id: "webforms.dialog.cancel" })}
                  </Button>
                }
                endAction={
                  <Button
                    ...
                    startIcon={<Trash />}
                  >
                    {formatMessage({ id: "webforms.dialog.confirm" })}
                  </Button>
                }
              />
            </Dialog>
