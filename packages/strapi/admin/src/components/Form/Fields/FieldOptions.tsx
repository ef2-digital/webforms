      ...
      fieldOptions = (
        <Box>
          <Textarea
            ...
            label={formatMessage({
              id: "webforms.forms.fields.extra_props.children",
            })}
            name="children"
            placeholder={formatMessage({
              id: "webforms.forms.fields.extra_props.children_placeholder",
            })}
          >
  ...
  return (
    <Stack spacing={3}>
      ...
      <Typography variant="omega" fontWeight="bold">
        {formatMessage({ id: "webforms.forms.fields.extra_props.validation" })}
      </Typography>
      <Checkbox
        name="isRequired"
        checked={checked}
      ...
      >
        {formatMessage({ id: "webforms.forms.fields.extra_props.required" })}
      </Checkbox>
    </Stack>
  );
};
